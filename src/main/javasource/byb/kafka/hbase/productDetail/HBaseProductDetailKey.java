...
public   class HBaseProductDetailKey {
    ...
    public static 	String	productPriceFromList	=	"productPriceFromList"	; //	商品价格2
    ...
    public static 	String	categoryPath	=	"categoryPath"	; //	商品类别编号
    ...
    public static  String productShortName_jd ="productShortName_jd";//京东产品名称shortName
